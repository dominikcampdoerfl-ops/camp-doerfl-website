...
export const legacyRedirectRules = Object.freeze({
  ...
  prefixes: Object.freeze([
    ...
    Object.freeze({ from: "/athletenbereich/bodybuilding-coach/", to: "/bodybuilding-coaching-wettkampfvorbereitung/" }),
    Object.freeze({ from: "/athletenbereich/bodybuilding/", to: "/bodybuilding-coaching-wettkampfvorbereitung/" }),
    ...
    Object.freeze({ from: "/bodybuilding/", to: "/bodybuilding-coaching-wettkampfvorbereitung/" }),
