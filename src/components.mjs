...
<html lang="de">
  <head>
    ...
    <meta name="twitter:image:alt" content="${socialImageAlt}">
	    ...
	    <link rel="stylesheet" href="/assets/styles.css?v=20260804-1">
	    <link rel="stylesheet" href="/assets/mobile-overrides.css?v=20260804-1">
  ...
  <body${bodyClass ? ` class="${bodyClass}"` : ""}>
    ...
    ${footer()}
    ${consentManager()}
    <script type="module" src="/assets/main.js?v=20260804-1"></script>
  </body>
</html>`;
}
